                            ...
                            <div className='w-full min-w-[280px]  md:min-w-[320px] max-w-[280px] md:max-w-[320px]  bg-white rounded-sm shadow '>
                                ...
                                <div className='p-4 grid gap-3'>
                                    ...
                                    <div className='flex gap-3'>
                                        <p className='text-orange-600 font-medium p-1 animate-pulse rounded-full bg-slate-200 w-full  py-2'></p>
                        ...
                        return(
                            <Link to={"/product/"+product?._id} className='w-full min-w-[280px]  md:min-w-[320px] max-w-[280px] md:max-w-[320px]  bg-white rounded-sm shadow ' onClick={scrollTop}>
                                ...
                                <div className='p-4 grid gap-3'>
                                    ...
                                    <div className='flex gap-3'>
                                        <p className='text-orange-600 font-medium'>{ displayINRCurrency(product?.sellingPrice) }</p>
